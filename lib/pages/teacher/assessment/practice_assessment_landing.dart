...
class PracticeAssessmentLanding extends StatefulWidget {
  PracticeAssessmentLanding({
    Key? key,
  }) : super(key: key);
  ...
  @override
  PracticeAssessmentLandingState createState() =>
      PracticeAssessmentLandingState();
}

class PracticeAssessmentLandingState extends State<PracticeAssessmentLanding> {
  ...
  void initState() {
    ...
    questionList =
        Provider.of<QuestionPrepareProviderFinal>(context, listen: false)
            .getAllQuestion;
    DateTime tsDate =
        DateTime.fromMicrosecondsSinceEpoch(assessment.assessmentStartdate!);
    startDateTime =
  ...
  void _copyToClipboard(String text) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        content: Text('Assessment ID copied to clipboard'),
      ),
    );
  }
                                    ...
                                    children: [
                                      ...
                                      ElevatedButton(
                                        style: ElevatedButton.styleFrom(
                                          ...
                                          minimumSize: const Size(143, 23),
                                          shape: RoundedRectangleBorder(
                                            borderRadius:
                                                BorderRadius.circular(30),
                                          ),
                                        ),
                                        child: Text(assessment.assessmentCode!,
                                            style: TextStyle(
                                                fontFamily: 'Inter',
                                      ...
                                      IconButton(
                                          ...
                                          onPressed: () async {
                                            ...
                                            String subject = Uri.encodeComponent(
                                                "QNA Practice : Assessment Details of ${assessment.assessmentCode}");
                                            String body = Uri.encodeComponent(
                                                "Assessment Details : \n\n\nSubject : ${assessment.subject}\nTopic : ${assessment.topic}\nDegree : ${assessment.getAssessmentModelClass}\nSemester : ${assessment.subTopic}\nTotal Marks : $totalMarks \nTotal Questions : ${assessment.questions!.length} ");
                                            Uri mail = Uri.parse(
                                ...
                                children: [
                                  ElevatedButton(
                                    onPressed: () {
                                      ...
                                      createassessmentModel.assessmentId =
                                          assessment.assessmentId;
                                      createassessmentModel.userId =
                                          userDetails.userId;
                                      createassessmentModel.assessmentCode =
                                          assessment.assessmentCode;
                                      createassessmentModel.assessmentType =
                                          assessment.assessmentType;
                                      createassessmentModel.assessmentStatus =
                                          assessment.assessmentStatus;
                                      createassessmentModel.totalScore =
                                          assessment.totalScore;
                                      createassessmentModel.totalQuestions =
                                          assessment.questions!.length;
                                      createassessmentModel
                                              .assessmentStartdate =
                                          assessment.assessmentStartdate;
                                      createassessmentModel.assessmentEnddate =
                                          assessment.assessmentEnddate;
                                      createassessmentModel.assessmentDuration =
                                          assessment.assessmentDuration;
                                      createassessmentModel.subject =
                                          assessment.subject;
                                      createassessmentModel.topic =
                                          assessment.topic;
                                      createassessmentModel.subTopic =
                                          assessment.subTopic;
                                      createassessmentModel
                                      ...
                                      for (int i = 0;
                                          i < assessment.questions!.length;
                                          i++) {
                                        Question tempQues = Question(
                                            questionId: assessment
                                                .questions![i].questionId,
                                            questionMarks: assessment
