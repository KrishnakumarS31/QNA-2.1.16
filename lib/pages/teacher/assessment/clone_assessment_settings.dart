...
class CloneAssessmentSettings extends StatefulWidget {
  ...
  @override
  CloneAssessmentSettingsState createState() => CloneAssessmentSettingsState();
}
...
class CloneAssessmentSettingsState extends State<CloneAssessmentSettings> {
  ...
  void initState() {
    ...
    assessment = Provider.of<CreateAssessmentProvider>(context, listen: false)
        .getAssessment;
    getAssessment = Provider.of<EditAssessmentProvider>(context, listen: false)
        .getAssessment;
    questionList =
                                    ...
                                    onPressed: () async {
                                      ...
                                      for (int i = 0;
                                        ...
                                        Question tempQues = Question(
                                            ...
                                            questionMarks:
                                                questionList[i].questionMark);
                                        if (getAssessmentQuestionID.contains(
                                            questionList[i].questionId)) {
                                        } else {
                                          assessment.questions?.add(tempQues);
                                        }
